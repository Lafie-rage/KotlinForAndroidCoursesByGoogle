...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        ...
        _entree.value?.let { selectedEntree ->
            previousEntreePrice = selectedEntree.price
        }
        ...
        _subtotal.value?.let { oldSubTotal ->
            _subtotal.value = oldSubTotal - previousEntreePrice
        }
    ...
    fun setSide(side: String) {
        ...
        _side.value?.let { selectedSide ->
            previousSidePrice = selectedSide.price
        }
        ...
        _subtotal.value?.let { oldSubTotal ->
            _subtotal.value = oldSubTotal - previousSidePrice
        }
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        _accompaniment.value?.let { selectedAccompaniment ->
            previousAccompanimentPrice = selectedAccompaniment.price
        }
        ...
        //  accompaniment.
        _subtotal.value?.let { oldSubTotal ->
            _subtotal.value = oldSubTotal - previousAccompanimentPrice
        }
